          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1">
              ...
              <p className="text-gray-600 leading-relaxed">
                这个梦想在"花花家"这个名字下，化作现实。花花家以其独特的设计和高质量的服饰，迅速赢得了国内外白领女性的青睐。
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mb-6">
                花花家的诞生不仅仅是为了满足女性对时尚的追求，更是为了传递一种信念：每个女性都应当在舞台上自信闪耀。
              </p>
              <p className="text-gray-600 leading-relaxed">
                从创立之初，花花家就秉持着"简约而不简单，优雅且自信"的设计理念，将传统与现代完美融合，展现出独特的东方美学。
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1">
              ...
              <p className="text-gray-600 leading-relaxed mb-6">
                花花家不是一个静止的符号，而是一个不断进化的象征。品牌始终追随时尚的脉搏，不断创新，勇毅前行。
              </p>
              <p className="text-gray-600 leading-relaxed">
                花花家希望通过每一件精心设计的服饰，传递一种力量，让每个穿上花花家的女性都能感受到那份来自内心的自信与美丽。无论你是在职场中挥洒才华，还是在生活中追求梦想，花花家始终与你同在，见证你每个闪耀时刻。
              </p>
            </div>
            <div className="order-1 md:order-2">
